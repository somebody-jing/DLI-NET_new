...
if __name__ == "__main__":
    source_folder = "/data/zj/SBIR/DLI-Net-main/Sketchy/sketch_temp/tx_000100000000/"
    txt_file = "/data/zj/SBIR/DLI-Net-main/Sketchy/sketch_test_relative_path.txt"
    destination_folder = "/data/zj/SBIR/DLI-Net-main/Sketchy/sketch/test/"
