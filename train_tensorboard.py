import torch
from dataset.qmul_v2_dataset import TrainDataset, TestPhDataset, TestSkDataset
...
def train():
    log_dir = "/data/zj/SBIR/DLI-Net-main/log_shoe_v2"
    ...
    train_dataset = TrainDataset(opt.ph_train_root, opt.ph_train_txt, opt.sk_train_root)
    ...
    if i % 5 == 0:
        writer.add_scalar('acc@1', acc_1, i)
        writer.add_scalar('acc@5', acc_5, i)
        writer.add_scalar('acc@10', acc_10, i)
